 ...
 */
	public int gains(EducationService e, BudgetService b, PopulationService p){	
		return (this.getNbPlaces()-((int)Math.random()*20*this.getNbPlaces()/100))*b.pauvrete(p)/100*this.prixPlace*this.potentiel(b)/100*(400+EducationService.getEdSecurite())/500*8;
	}
